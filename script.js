//Value next to slider in range is updated
function updateRate()
    {
...
//Output displayed based on user input
function compute()
{
...
//validate Principal input box not zero or negative values and if so show alert
